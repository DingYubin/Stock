package ruifu.com.shares.view;

/**
 * Created by 王群 on 2015/10/21.
 */
...
public class TimesView extends GridChart {
    ...
    private void drawTitles(Canvas canvas) {
        ...
        canvas.drawText("15:00", viewWidth - 2 - DEFAULT_AXIS_TITLE_SIZE * 2.5f, uperBottom
                + DEFAULT_AXIS_TITLE_SIZE, paint);
        */
        canvas.drawText(timeAxis.get(0), 2, uperBottom + DEFAULT_AXIS_TITLE_SIZE, paint);
        canvas.drawText(timeAxis.get(1), viewWidth / 2.0f - DEFAULT_AXIS_TITLE_SIZE * 2.5f,
                uperBottom + DEFAULT_AXIS_TITLE_SIZE, paint);
        canvas.drawText(timeAxis.get(2), viewWidth - 2 - DEFAULT_AXIS_TITLE_SIZE * 2.5f, uperBottom
                + DEFAULT_AXIS_TITLE_SIZE, paint);
    }
